...
<table cellpadding=0 cellspacing=0 class="tbl_listaProd">
	<thead>
		<tr>
                    <td>C&oacute;digo Doa&ccedil;&atilde;o</td>
                    <td>Benefici&aacute;rio</td>
                    <td>DATA</td>
		</tr>
	</thead>
	<tbody>
...
while($row = mysql_fetch_array($doacao)) {
	echo  "<tr>";
	echo " <td>".$row['codDoacao']."</td>";
	 ?>
        <td><a href="#" onclick="verCupom('<?php echo $row['caminho']; ?>')"><?php echo $row['nome']; ?></a></td>
        <?php ;
